...
class Favorite(db.Model):
    ...
    planet_id = db.Column(db.Integer, db.ForeignKey('planets.id_planeta'), nullable=True)
    people_id = db.Column(db.Integer, db.ForeignKey('people.id_persona'), nullable=True)
